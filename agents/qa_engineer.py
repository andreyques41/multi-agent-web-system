...
def create_qa_engineer_agent(tools: Optional[List] = None, verbose: bool = True, llm = None, model_name: Optional[str] = None) -> Agent:
    """
    ...
    Args:
        ...
        model_name: Specific model to use (e.g., 'o3-mini')
    ...
    if llm is None:
        ...
        model_key = model_name or get_best_model_for_agent('qa')
